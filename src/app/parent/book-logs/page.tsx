        ...
        <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="bg-white p-4 rounded-lg shadow space-y-4">
                ...
                <div>
                    ...
                    <input id="bookName" type="text" value={bookName} onChange={e => setBookName(e.target.value)} required className="w-full p-2 border rounded dark:text-gray-800"/>
                </div>
                <div>
                    <label htmlFor="description" className="block text-sm font-medium text-gray-700">Kısa Açıklama (Opsiyonel)</label>
                    <textarea id="description" value={description} onChange={e => setDescription(e.target.value)} rows={3} className="w-full p-2 border rounded dark:text-gray-800"/>
                </div>
